USE [VISTA]
GO
/****** Object:  StoredProcedure [dbo].[sp_Reporte_GenerarExport]    Script Date: 10/07/2026 02:15:37 p. m. ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    -- Aquí NO se aplica el tope de 100 filas — el export está pensado
    -- para traer todo el resultado, vía streaming.
    ------------------------------------------------------------------
    IF EXISTS (
        SELECT 1
        FROM dbo.Rep_CatGrupoObligatorio g
